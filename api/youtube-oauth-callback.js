  ...
  try {
    ...
    const { error: upsertError } = await supabase
      ...
      .upsert({
        ...
        scopes: ['https://www.googleapis.com/auth/youtube.readonly', 'https://www.googleapis.com/auth/yt-analytics-monetary.readonly'],
        is_active: true,
    ...
    await logAuditEvent(stateRecord.user_id, 'oauth_success', {
      ...
      metadata: {
        ...
        scopes: ['youtube.readonly', 'yt-analytics-monetary.readonly']
      }
    });

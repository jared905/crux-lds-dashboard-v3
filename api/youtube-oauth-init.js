...
export default async function handler(req, res) {
  ...
  try {
    ...
    await supabase.from('youtube_oauth_audit_log').insert({
      ...
      user_agent: userAgent,
      metadata: {
        scopes: ['youtube.readonly', 'yt-analytics.readonly', 'yt-analytics-monetary.readonly', 'youtubereporting.readonly', 'userinfo.email'],
        pkce_method: 'S256'
      }
    });
    ...
    const params = new URLSearchParams({
      ...
      response_type: 'code',
      scope: 'https://www.googleapis.com/auth/youtube.readonly https://www.googleapis.com/auth/yt-analytics.readonly https://www.googleapis.com/auth/yt-analytics-monetary.readonly https://www.googleapis.com/auth/youtubereporting.readonly https://www.googleapis.com/auth/userinfo.email',
